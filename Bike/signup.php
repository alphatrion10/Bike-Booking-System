...
<html lang="en">
 ...
 ?>
  ...
  <h3 class="text-center my-4"><strong style="color:white; background-color:rgba(11, 3.9, 3.9, 0.7);font-size: 200%;box-shadow: 10px 10px 10px black;">New Here? Please Signup</strong></h3>
  <form action ="signup.php" method = "post" style ="display: flex;
    flex-direction: column;
    align-items:center;
    padding:15px;
    background-color:rgba(11, 3.9, 3.9, 0.7);;
    margin-right:200px;margin-left: 200px;color: white;box-shadow: 10px 10px 10px black;">
  ...
  <div class="form-group col-md-6">
    ...
    <small id="emailHelp" class="form-text text-muted" style="color: white;">Username should have minimum 5 and maximum 10 characters.</small>
  </div>
  <div class="form-group col-md-6">
