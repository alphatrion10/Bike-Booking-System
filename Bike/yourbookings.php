...
<h3 class= "text-center my-4" style="color: white;font-size: 350%;">Your Bookings</h3>
<div class="container my-4">
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col" style="color: black;">Bike Photo</th>
          <th scope="col" style="color: black;">Bike Name</th>
          <th scope="col" style="color: black;">Customer Username</th>
          <th scope="col" style="color: black;">Booking ID</th>
          <th scope="col" style="color: black;">Bike Number</th>
          <th scope="col" style="color: black;">Final Price</th>
    ...
    Array.from(cancel).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to cancel the booking!?")) {
          console.log("yes");
          window.location = `yourbookings.php?cancel=${sno}`;
