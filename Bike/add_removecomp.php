...
<html lang="en">
 ...
 ?>
  <h3 class= "text-center my-4" style="color: white;background-color: rgba(11, 3.9, 3.9, 0.7); font-size: 250%;">Add Company Information</h3>
  <div class="container my-4">
  <form action ="add_removecomp.php" method = "post" style ="display: flex;
    flex-direction: column;
    align-items: center;
    padding:15px;background-color: rgba(11, 3.9, 3.9, 0.7); color:white;box-shadow: 10px 10px 10px black;" enctype="multipart/form-data">
...
<h3 class= "text-center my-4" style="color: white;">Available Company Details</h3>
<div class="container my-4">


    <table class="table" id="myTable" style="color: black;background-color: white;box-shadow: 10px 10px 10px black;">
      <thead>
        <tr>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to remove this Company!?")) {
          console.log("yes");
          window.location = `add_removecomp.php?delete=${sno}`;
