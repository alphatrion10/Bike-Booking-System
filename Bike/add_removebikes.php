...
<html lang="en">
 ...
 ?>
  <h3 class= "text-center my-4" style="font-family: 'Abril Fatface', cursive; font-size:250%; ">Add Bike information</h3>
  <div class="container my-4">
  <form action ="add_removebikes.php" method = "post" style ="display: flex;
    flex-direction: column;
    align-items: center;
    padding:15px;background-color:rgba(11, 3.9, 3.9, 0.7); color: white;margin-right: 200px;margin-left: 200px;box-shadow: 10px 10px 10px darkblue;" enctype="multipart/form-data">
  ...
  <button type="submit" class="btn btn-primary col-md-1" style="font-size: 90%;text-align: center;">Submit</button>
</form>
</div>
<hr>

<h3 class= "text-center my-4" style="color: white;">Available Bike details</h3>
<div class="container my-4">
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col" style="color:white">Bike Photo</th>
          <th scope="col" style="color:white">Bike Name</th>
          <th scope="col" style="color:white">Company</th>
          <th scope="col" style="color:white">Type</th>
          <th scope="col" style="color:white">Bike Number</th>
          <th scope="col" style="color:white">Availability</th>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to remove this bike!?")) {
          console.log("yes");
          window.location = `add_removebikes.php?delete=${sno}`;
