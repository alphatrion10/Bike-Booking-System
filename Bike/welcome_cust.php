...
<html lang="en">
  ...
  <img src="duc.jpg" class="card-img-top" alt="..."style="border-radius: 20px;">
  <div class="card-body my-2">
    <h5 class="card-title" style="color: white;">View and Book Bikes</h5>
    <p class="card-text" style="color: white;">View the Bikes available and book them.</p>
...
<div class="col-md-4">
  ...
  <div class="card-body my-2">
    <h5 class="card-title" style="color: white;">View Companies</h5>
    <p class="card-text" style="color: white;">View the different companies that are available.</p>
...
<div class="col-md-4">
  ...
  <div class="card-body my-2">
    <h5 class="card-title" style="color: white;">View your Bookings</h5>
    <p class="card-text" style="color: white;">View the Bike Bookings done by you.</p>
